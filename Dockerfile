...
RUN apt-get -qq update && \
      ...
      libxml2-utils lsof lzop maven nano openjdk-8-jdk pngcrush procps python3 \
      python-is-python3 rsync schedtool squashfs-tools tmux wget xdelta3 xsltproc yasm zip \
      zlib1g-dev \
